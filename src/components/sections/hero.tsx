    ...
    return <section className="py-10">
        <div className="section__container flex flex-col md:flex-row md:items-center lg:items-end justify-between gap-10">
            ...
            <div className="relative w-full md:w-fit">
                ...
                <div className="w-full md:w-11/12 absolute bottom-0 right-0 shadow-[0_0_20px_3px_rgba(0,0,0,0.3)] rounded-lg px-8 py-6 bg-[#9C8F8F] bg-opacity-20 font-bold border-1 border-gray-50">
                    <div className="flex items-center justify-between">
                        <span className="flex gap-1 items-center text-l_blue">
                            <span className="text-4xl font-semibold">10<sup>+</sup></span>
                            <span className="text-black text-sm"> years  of<br /> experience</span>
                        </span>
                        <span className="flex gap-1 items-center text-l_blue">
                            <span className="text-4xl font-semibold">1000<sup>+</sup></span>
                            <span className="text-black text-sm">happy <br />clients</span>
                        </span>
                    </div>
                </div>
            </div>
